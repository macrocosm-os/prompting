...
class HFTextGeneration(ReproducibleHF):
    def __init__(self, model_id: str = "meta-llama/Meta-Llama-3.1-70B-Instruct-AWQ-INT4", device: str = "cuda:0", sampling_params: dict[str, str | float | int | bool] | None = None):
