...
class MockPipeline():
    ...
    def __init__(self, model_id='mock', device_map='mock-cuda', torch_dtype='torch.mock16', phrase='mock reply', model_kwargs=None):
    ...
    def postprocess(self, output, **kwargs):
        ...
        output = output.split(self.model.tokenizer.role_expr.format(role='assistant'))[-1].strip()
...
class MockMetagraph(bt.metagraph):
    ...
    def __init__(self, netuid=1, network='mock', subtensor=None):
        super(MockMetagraph, self).__init__(netuid=netuid, network=network, sync=False)
