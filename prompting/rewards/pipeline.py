...
#     def validate_tasks_and_load_reward_pipeline(self) -> "RewardPipeline":
#         self.validate_tasks()
...
#         active_reward_models: list[BaseRewardModel] = []
...
#             reward_models[model.name] = model(device=self.device, **params)
