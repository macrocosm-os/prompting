...
check_for_update() {
    if [ -d "./.git" ]; then
        ...
        echo "The installation does not appear to be done through Git. Please install from source at https://github.com/macrocosm-os/prompting and rerun this script."
    fi
}
